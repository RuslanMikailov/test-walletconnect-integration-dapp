...
import { apiGetGasPrices, apiGetAccountNonce, Api } from "./helpers/api";
import {
  sanitizeHex,
  verifySignature,
...
class App extends React.Component<any, any> {
  ...
  public connect = async () => {
    ...
    const provider = new WalletConnectProvider({
      rpc: {
        5555558: "https://jsonrpc-endpoint-test.imversed.com"
      },
    });
  ...
  public getAccountAssets = async () => {
    ...
    try {
      const assets = await this.api.getAccountAssets(address, chainId);
